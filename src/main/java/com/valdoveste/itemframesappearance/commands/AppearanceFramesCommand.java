...
public class AppearanceFramesCommand implements CommandExecutor {

    ItemFramesAppearance plugin;

    public AppearanceFramesCommand(ItemFramesAppearance plugin) {
        this.plugin = plugin;
    }
            ...
            if (sender instanceof Player playerSender) {
                ...
                if (args.length == 0) {
                    playerSender.sendMessage(
                            ChatColor.GRAY + "[" + ChatColor.AQUA + "iFrame" + ChatColor.GRAY + "] "
